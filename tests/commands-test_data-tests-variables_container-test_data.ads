...
package Commands.Test_Data.Tests.Variables_Container.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Commands.Variables_Container.Test_Data (Test);
...
end Commands.Test_Data.Tests.Variables_Container.Test_Data;
